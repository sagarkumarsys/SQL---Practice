...
select * from employees order by salary asc;  -- Display all employees in ascending order of salary.

select * from employees order by salary desc;  -- Display all employees in descending order of salary.

select * from employees order by name asc;  -- Display employees in alphabetical order by name.

select * from employees order by dept asc, salary desc;  -- Display employees by department ascending and salary descending.

select * from employees order by salary desc, name asc;  -- Display employees by salary descending. If salary is same, sort by name ascending.
